...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_apostrophe = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox_apostrophe.setFont(font)
        self.checkBox_apostrophe.setChecked(True)
        self.checkBox_apostrophe.setObjectName("checkBox_apostrophe")
        self.name_layout.addWidget(self.checkBox_apostrophe)
        ...
        self.plainTextEdit_from = QtWidgets.QPlainTextEdit(self.group_names)
        self.plainTextEdit_from.setEnabled(False)
        self.plainTextEdit_from.setGeometry(QtCore.QRect(10, 290, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.plainTextEdit_from.setFont(font)
        self.plainTextEdit_from.setObjectName("plainTextEdit_from")
        self.plainTextEdit_to = QtWidgets.QPlainTextEdit(self.group_names)
        self.plainTextEdit_to.setEnabled(False)
        self.plainTextEdit_to.setGeometry(QtCore.QRect(210, 290, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.plainTextEdit_to.setFont(font)
        self.plainTextEdit_to.setObjectName("plainTextEdit_to")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/folder-outline.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_path.setIcon(icon1)
        self.pushButton_path.setObjectName("pushButton_path")
        self.plainTextEdit_filepath = QtWidgets.QPlainTextEdit(self.group_file_open)
        self.plainTextEdit_filepath.setGeometry(QtCore.QRect(50, 30, 761, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.plainTextEdit_filepath.setFont(font)
        self.plainTextEdit_filepath.setObjectName("plainTextEdit_filepath")
        ...
        self.group_options.setGeometry(QtCore.QRect(370, 320, 271, 121))
        self.group_options.setObjectName("group_options")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.group_options)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 253, 91))
        ...
        self.radioButton__dialog.setChecked(True)
        self.radioButton__dialog.setObjectName("radioButton__dialog")
        self.options_layout.addWidget(self.radioButton__dialog)
        self.radioButton__skip = QtWidgets.QRadioButton(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.radioButton__skip.setFont(font)
        self.radioButton__skip.setObjectName("radioButton__skip")
        self.options_layout.addWidget(self.radioButton__skip)
        ...
        self.group_tags.setGeometry(QtCore.QRect(370, 160, 471, 161))
        self.group_tags.setObjectName("group_tags")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.group_tags)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 471, 131))
        ...
        MainWindow.setTabOrder(self.pushButton_path, self.plainTextEdit_filepath)
        MainWindow.setTabOrder(self.plainTextEdit_filepath, self.check_include_subfolder)
        ...
        MainWindow.setTabOrder(self.checkBox_brackets, self.checkBox_apostrophe)
        MainWindow.setTabOrder(self.checkBox_apostrophe, self.checkBox_defis)
        ...
        MainWindow.setTabOrder(self.checkBox_user_replace, self.plainTextEdit_from)
        MainWindow.setTabOrder(self.plainTextEdit_from, self.plainTextEdit_to)
        MainWindow.setTabOrder(self.plainTextEdit_to, self.checkBox_delete_tags)
        ...
        MainWindow.setTabOrder(self.radioButton__dialog, self.radioButton__skip)
        MainWindow.setTabOrder(self.radioButton__skip, self.pushButton_start)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_apostrophe.setText(_translate("MainWindow", "Delete if file have same filename"))
        ...
        self.radioButton_all.setText(_translate("MainWindow", "Do all"))
        self.radioButton__dialog.setText(_translate("MainWindow", "Open dialog to correct"))
        self.radioButton__skip.setText(_translate("MainWindow", "Skip file"))
